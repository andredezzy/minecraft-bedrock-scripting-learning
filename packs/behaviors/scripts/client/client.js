...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("scriptinglearning:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("scriptinglearning:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("scriptinglearning:pinky", pinkyEventData);
	}
}
